---
title: Upgrading your CLI to rdme@10
excerpt: ''
deprecated: false
hidden: false
metadata:
...
More installation options can be found in [ReadMe's docs](https://github.com/readmeio/rdme/tree/v10?tab=readme-ov-file#setup) on GitHub.
